...
public class Knight extends Unit implements Closable, Ridable {
    public Knight(String nameOfUnit, int healthPoint, int damage, int attackRange, int protection, int movement, int price) {
