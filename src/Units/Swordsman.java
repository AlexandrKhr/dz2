...
public class Swordsman extends Unit implements Closable {
    public Swordsman(String nameOfUnit, int healthPoint, int damage, int attackRange, int protection, int movement, int price) {
